import{t as c}from"./CihHYs_k.js";import{bR as s,af as d,bs as t,b3 as n,aE as l,b0 as i,bK as r,bd as b,ab as h,bA as k,ad as g,b2 as u}from"./D_fBr3q7.js";function v(e){return e.length===0}const x=["type","disabled","data-border","data-color"],f={key:0},w=Object.assign({name:"WButton",inheritAttrs:!1},{__name:"WButton",props:{disabled:{type:Boolean,required:!1},readonly:{type:Boolean,required:!1},border:{type:Boolean,required:!1,default:!0},unstyle:{type:Boolean,required:!1},label:{type:String,required:!1,default:""},color:{type:[String,Boolean],required:!1,default:!1}},setup(e){const o=s();return(a,y)=>(b(),d("button",i({class:!e.unstyle&&r(c)(`
		button
		flex
		cursor-pointer
		items-center

import{a as n,U as e,h as d,j as v,q as w}from"./WRoot-Bkx09XHA.js";import{y as p,ae as f,S as m}from"./vue.esm-bundler-AO_tuUZ6.js";import{l as b,x as c}from"./index-C-090Xcl.js";import"./iframe-J7JveNbZ.js";import"./twMerge-CLwyhV7-.js";const S={component:b,title:"Components/MetamorphosisTheme",args:{}},s={tags:["skip-smoke-test"],render:o=>{const l=o;return{components:c,setup(){return{args:l,theme:p(w)}},template:`
        ...
        `}},args:{options:{forceDisplayStopHandles:!0}}},a={render:o=>{const l=o;return{components:c,setup(){const u=new n(e.px,20),g=new d("gradient",e.rgb,[new n(e.rgb,{r:255,g:50,b:50}),new n(e.rgb,{r:50,g:100,b:255}),new n(e.rgb,{r:50,g:255,b:100})],[0,.5,1]),h=new d("spacing",e.px,[new n(e.px,{_:0}),new n(e.px,{_:8}),new n(e.px,{_:16})],[0,.3,1]),r=p(new v({radius:u,gradient:g,spacing:h})),t=m(null);f(t,()=>{t.value?r.attach(t.value):r.detach()});const i=m(JSON.stringify(r.css,null,"	"));return r.on("change",()=>{i.value=JSON.stringify(r.css,null,"	")}),{args:l,css:i,dummyEl:t,theme:r}},template:`
            <div class="flex flex-col gap-4 w-full max-w-xl">
                <WMetamorphosisTheme v-bind="{
                    ...args,
                    theme
...
}`,...a.parameters?.docs?.source},description:{story:"A custom theme with all three supported variable types: a numeric ControlVar, a color InterpolatedVars, and a numeric InterpolatedVars.",...a.parameters?.docs?.description}}};const C=["Primary","CustomTheme"];export{a as CustomTheme,s as Primary,C as __namedExportsOrder,S as default};

import{f as d}from"./chunk-NAVWDHVN-4xFUB_is.js";import{S as a,e as b}from"./vue.esm-bundler-AO_tuUZ6.js";import{k as h,N as m}from"./WRoot-Bkx09XHA.js";import{x as p}from"./index-C-090Xcl.js";import"./iframe-J7JveNbZ.js";import"./twMerge-CLwyhV7-.js";const w={component:h,title:"Components/Notifications",args:{_withTitle:!0}},i={render:r=>{const l=r;return{components:p,setup(){const n=new m({});let e=0;const t=a(l._withTitle),s=a(!1),c=a(!1),u=`
 Simulating lots of text:
${d.lorem.paragraphs(20)}`,o=b(()=>c.value?u:"");return{notifyRequiresAction:f=>{e++,n.notify({title:t.value?`Notification(${e})`:void 0,message:`This is a cancellable notification that requires action. Pick an option:${o.value}`,requiresAction:!0,options:["Ok","Default Answer","Cancel"],default:"Default Answer",cancellable:!0,...f})},notifyTimeoutable:()=>{e++,n.notify({title:t.value?`Notification(${e})`:void 0,message:`This is a notification. No action required.${o.value}`,timeout:s.value?!1:5e3})},notifyNonCancellable:()=>{e++,n.notify({title:t.value?`Notification(${e})`:void 0,message:`This is a non-cancellable notification. Pick an option:${o.value}`,options:["Ok","Default Answer"],default:"Default Answer",cancellable:!1})},notifyWithDangerousOption:()=>{e++,n.notify({title:t.value?`Notification(${e})`:void 0,message:`This is a cancellable notification that has a dangerous option. Pick an option:${o.value}`,options:["Ok","Default Answer","Dangerous Option","Cancel"],cancellable:!0,default:"Default Answer",dangerous:["Dangerous Option"]})},notifyNonCancellableRequiresAction:()=>{e++,n.notify({title:t.value?`Notification(${e})`:void 0,message:`This is a non-cancellable notification. Pick an option:${o.value}`,requiresAction:!0,options:["Ok","Default Answer"],default:"Default Answer",cancellable:!1})},handler:n,withTitle:t,disableTimeout:s,lotsOfText:c,args:{outline:!1,...l}}},backgrounds:{disable:!0},template:`

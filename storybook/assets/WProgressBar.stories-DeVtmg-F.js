import{S as c,M as m}from"./vue.esm-bundler-AO_tuUZ6.js";import{x as p}from"./index-C-090Xcl.js";import{l as d}from"./WRoot-Bkx09XHA.js";import"./twMerge-CLwyhV7-.js";import"./iframe-J7JveNbZ.js";const S={component:d,title:"Components/ProgressBar",args:{label:"Label",_timeout:1e3,_add:10,_start:50}},e={render:g=>{const r=g;return{components:p,setup:()=>{const i=c(!1),s=c(r._start);if(r.progress)s.value=r.progress;else{let l=!1;const u=setInterval(()=>{l||(s.value>=100?(l=!0,setTimeout(()=>{s.value=0,l=!1},2e3)):s.value+=r._add)},r._timeout);m(()=>{clearInterval(u)})}return{args:{...r},forceFull:i,progress:s}},template:`
...
}`,...t.parameters?.docs?.source}}};const y=["Primary","ReallyLongLabel","Static","AutoHiding","AutoHidingNoKeepSpace"];export{o as AutoHiding,t as AutoHidingNoKeepSpace,e as Primary,a as ReallyLongLabel,n as Static,y as __namedExportsOrder,S as default};

import{S as i,af as f}from"./vue.esm-bundler-AO_tuUZ6.js";import{v as y}from"./vExtractRootEl-DETW6UcW.js";import{z as p,x as v,v as b}from"./index-C-090Xcl.js";import"./WRoot-Bkx09XHA.js";import"./iframe-J7JveNbZ.js";import"./twMerge-CLwyhV7-.js";const m=(r,o,t,a)=>({keydown(e){if(e.preventDefault(),!p(e)&&e.key==="Escape"){r.value=t.value,o.value=!1;return}if(!p(e)&&e.key==="Enter"){o.value=!1;return}r.value+=` ${e.key}`},mousedown(e){const l=e.target,u=a.value;l===u||u?.contains(l)||(r.value+=` ${e.button}`,e.preventDefault())},wheel(e){r.value+=` ${e.deltaY>0?"↓":"↑"}`,e.preventDefault()}}),g=(r,o,t,a)=>()=>{o.value||(r.value&&(a?.value?(a.value.push(r.value),t.value=""):t.value=r.value),r.value="")};m.__docgenInfo={exportName:"createRecorderHandler",displayName:"createRecorderHandler",type:2,props:[{name:"value",global:!1,description:"",tags:[],required:!0,type:"string",declarations:[],schema:"string"},{name:"__@RefSymbol@3115",global:!1,description:`Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE
autocomplete, so we use a private Symbol instead.`,tags:[],required:!0,type:"true",declarations:[],schema:"true"}],events:[],slots:[],exposed:[],sourceFiles:"/home/runner/work/ui/ui/src/runtime/helpers/storybook.ts"};g.__docgenInfo={exportName:"createRecorderWatchEffect",displayName:"createRecorderWatchEffect",type:2,props:[{name:"value",global:!1,description:"",tags:[],required:!0,type:"string",declarations:[],schema:"string"},{name:"__@RefSymbol@3115",global:!1,description:`Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE

import{f as n}from"./chunk-NAVWDHVN-4xFUB_is.js";import{Q as x,S as P}from"./vue.esm-bundler-AO_tuUZ6.js";import{x as v,r as W}from"./index-C-090Xcl.js";import"./WRoot-Bkx09XHA.js";import"./iframe-J7JveNbZ.js";import"./twMerge-CLwyhV7-.js";const y=Array.from({length:100}).fill(0).map(a=>n.lorem.sentence(n.number.int({min:1,max:50}))),$={component:W,title:"Components/Table"},e={render:a=>{const r=a;return{components:v,setup:()=>{const _=P(!0),I=P(!1);return{args:x({...r,resizable:{enabled:!0,...r.resizable}}),debugGrips:I,show:_}},template:`
        ...
        `}},u={...e,args:{...e.args,resizable:{fitWidth:!1}}},b={...e,args:{...e.args,resizable:{enabled:!0},stickyHeader:!0,wrapperAttrs:{class:`
                max-h-[50dvh]
            `},values:Array.from({length:200}).fill(0).map((a,r)=>({prop1:`Item${r+1} Prop 1`,prop2:`Item${r+1} Prop 2`,prop3:`Item${r+1} Prop 3`}))}},s={...e,args:{...e.args,resizable:{enabled:!0},virtualizerOptions:{enabled:!0},stickyHeader:!0,wrapperAttrs:{class:`
                max-h-[50dvh]
            ...
            [&_td]:no-truncate!
            [&_th]:no-truncate!
        `,values:Array.from({length:1e4}).fill(0).map((a,r)=>({prop1:`Item${r+1} Prop 1: ${n.helpers.arrayElement(y)}`,prop2:`Item${r+1} Prop 2: ${n.helpers.arrayElement(y)}`,prop3:`Item${r+1} Prop 3: ${n.helpers.arrayElement(y)}`}))},parameters:{tags:["skip-smoke-test"]}},z={...s,args:{...s.args,resizable:{fitWidth:!1},class:`
            [&_th]:no-truncate!
            [&_th]:whitespace-nowrap!
            [&:not(.resizable-cols-setup)]:w-max
            [&:not(.resizable-cols-setup)_th]:w-max
        `,wrapperAttrs:{class:"max-h-[50dvh]"},values:Array.from({length:1e4}).fill(0).map((a,r)=>({prop1:`Item${r+1} Prop 1`,prop2:`Item${r+1} Prop 2`,prop3:`Item${r+1} Prop 3`}))}},o={render:a=>({components:v,setup:()=>{const r=P(!1);return{args:a,debugGrips:r}},template:`
...
}`,...h.parameters?.docs?.source}}};const T=["Primary","NoCellBorders","NoBorders","NoCellBordersNoBorders","SquareBorders","NoHeader","NoHeaderNoBorders","NoHeaderNoCellBorders","InitialSize","FitWidthFalse","StickyHeader","VirtualizedFixedHeight","VirtualizedDynamicHeightExperimental","VirtualizedFitWidthFalse","ThreeColSomeColsNotResizable","FourColSomeColsNotResizable"];export{u as FitWidthFalse,h as FourColSomeColsNotResizable,g as InitialSize,l as NoBorders,t as NoCellBorders,p as NoCellBordersNoBorders,c as NoHeader,d as NoHeaderNoBorders,m as NoHeaderNoCellBorders,e as Primary,i as SquareBorders,b as StickyHeader,o as ThreeColSomeColsNotResizable,f as VirtualizedDynamicHeightExperimental,z as VirtualizedFitWidthFalse,s as VirtualizedFixedHeight,T as __namedExportsOrder,$ as default};
